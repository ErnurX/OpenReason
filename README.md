...
repository implements **Stage 10: Domain Packs** and **Stage 11: Collaboration** on the canonical substrate.
...
provides a token-authenticated graphical project surface.
...
pnpm rw collab bootstrap <project-dir> --actor <human-actor-id>
pnpm rw collab members <project-dir> --actor <human-actor-id>
pnpm rw collab member add <project-dir> --actor <owner-id> --member <human-actor-id>
    --role <owner|researcher|contributor|reviewer|compute-operator|viewer> --reason <text>
pnpm rw collab comment <project-dir> --actor <human-actor-id> --object <id> --version <id>
    --body <text> [--branch <id-or-name>]
pnpm rw collab request-review <project-dir> --actor <human-actor-id> --statement <claim-id>
    --statement-version <version-id> --evidence <evidence-id@version-id,...> --summary <text>
    [--branch <id-or-name>]
pnpm rw collab decide-review <project-dir> --actor <reviewer-id> --review <id>
    --outcome <approved|rejected> --rationale <text>
pnpm rw collab authorize-merge <project-dir> --actor <owner-id> --subject <human-actor-id>
    --source <id-or-name> --target <id-or-name> --reason <text>
pnpm rw collab merge <project-dir> --actor <human-actor-id> --authorization <id>
...
Stage 11 establishes explicit repository collaboration, membership roles
(`owner`, `researcher`, `contributor`, `reviewer`, `compute-operator`,
`viewer`), immutable comment and review records, and owner-authorized branch
merges. See [ADR-0016](docs/architecture/adr/0016-stage-11-collaboration-rbac.md).
...
- `packages/store` — atomic JSONL event segments, filesystem CAS, disposable
  ...
  003 fixtures.
- `packages/workbench` — local browser research shell and token-authenticated
  loopback API.
...
- [Stage 11 exit](docs/roadmap/stage-11-exit.md)
- [Stage 12 exit](docs/roadmap/stage-12-exit.md)
